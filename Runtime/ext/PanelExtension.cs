...
namespace unvs.ext
{
    public static class PanelExtension
    {
        ...
        public static void SetPosition(this Image panel,Vector2 pos,Vector2 sizeOfPanel)
        {
            var size = panel.GetSize();
            if (sizeOfPanel != Vector2.zero)
            {
                size = sizeOfPanel;
            }
...
Pivot: (0.5, 0.5).
        ...
        /// <summary>
        /// Checks if a screen space position (e.g., mouse position) is over the UI Image area.
        /// Works for all Canvas render modes: Overlay, Camera, and World Space.
        /// </summary>
        /// <param name="panel">The target UI Image.</param>
        /// <param name="screenPoint">The position in screen pixels (Vector2).</param>
        /// <returns>True if the point is within the Image's rectangle.</returns>
        public static bool ContainsScreenPoint(this Image panel, Vector2 screenPoint)
        {
        ...
        //public static bool ContainsGamewordlPoint(this Image panel, Vector2 gameWorldPint)
        //{
