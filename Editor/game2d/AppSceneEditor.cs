...
//            }
//            if (GUILayout.Button("Create Scene loader "))
//            {
//                var appscene = (AppScene)target;
//                var ret = appscene.EditorCreatePrefab<AppSceneLoader>("SceneLoader");
//                appscene.SceneLoaderPath = ret.PrefabPath;
//                appscene.SceneLoader = ret.value;
//                appscene.EditorSave();
